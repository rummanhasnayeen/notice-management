    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item nav-link waves-effect" href="{{ url('/assignteacher') }}">Assign teachers</a>
        @endif
          <a class="dropdown-item nav-link waves-effect" href="{{ url('/profile') }}">Profile</a>
          <a class="dropdown-item nav-link waves-effect" href="{{  url('/category') }}">Category</a>
